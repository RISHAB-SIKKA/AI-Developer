            ...
            <div className='conversation-area flex-grow flex flex-col'>
                ...
                <div className='message-box p-2 flex-grow flex flex-col gap-2'>
                    ...
                    <div className='message max-w-56 flex flex-col p-2 bg-slate-50 w-fit rounded-md'>
                        ...
                        <p className='text-sm'>loremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremloremlorem</p>
                    </div>
                    ...
                    <div className="users-list flex flex-col gap-2 mb-16 max-h-96 overflow-auto">
                        {users.map(user => (
                                <div 
                                    key={user.id} 
                                    className= {`
                                            user cursor-pointer hover:bg-slate-200 
                                            ${Array.from(selectedUserId).indexOf(user._id) != -1 ? 'bg-slate-200' : ""} p-2 flex gap-2 items-center`} 
